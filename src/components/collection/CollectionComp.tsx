...
const CollectionComp: React.FC = () => {
  const history = useHistory();
  const classes = useStyles();
  const [collections, setCollections]: [ICollection[], (Brand: ICollection[]) => void] = React.useState(defaultCollection);
  ...
  React.useEffect(() => {
    axios
      .get<ICollection[]>(`${process.env.REACT_APP_BASE_URL}/collections`)
      .then((response) => {
